...
tableau = [pygame.image.load('Tableau1.png'), pygame.image.load('Tableau2.png'),
           pygame.image.load('Tableau3.png'), pygame.image.load('Tableau4.png'),
           pygame.image.load("Castle_inside.png"), pygame.image.load("game_over.png")]

# sprite
sprite_wizard = pygame.image.load('Magier.png')
sprite_bat = pygame.image.load('32x32-bat-sprite.png')
sprite_knight_walking = pygame.image.load('knight_walk_animation.png')
sprite_coffre = pygame.image.load('Coffre.png')
...
pygame.display.set_caption("Legends_of_Carthageo")

def sentence(x, y, text, couleur, taille):
    font = pygame.font.Font(None, 22)
    sentence = font.render(text, taille, couleur)
    surface.blit(sentence, (x, y))
